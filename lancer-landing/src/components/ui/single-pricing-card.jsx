...
function SinglePricingCardContent({
  ...
  return (
    <Card
      className={`overflow-hidden border border-primary/10 relative group ${
        cardClassName || ''
      }`}
    >
      {animationEnabled && (
      ...
      <div className='flex flex-col md:flex-row'>
        ...
        <div className='p-6 md:p-8 md:w-1/2 flex flex-col'>
          ...
          {testimonials.length > 0 && (
            <>
              <div className='rounded-lg p-3 border border-border/50 relative overflow-hidden min-h-[160px] mb-4'>
          ...
          <div className='mt-6'>
            ...
            <div className='flex items-center gap-2'>
              {price.discount && (
                <Badge
                  variant='outline'
                  className={`border-green-400/30 text-green-500 ${
