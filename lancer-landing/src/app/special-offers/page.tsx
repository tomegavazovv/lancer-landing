...
const specialOffers: SpecialOffer[] = [
  {
    ...
    originalPrice: '$499',
    discount: '$200 off',
    description: 'The only playbook you will ever need to turn Upwork into a predictable acquisition channel.',
    features: [
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
          <AnimatedGroup preset="blur-slide" threshold={0.1}>
            ...
            <p className="mt-6 text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Exclusive digital products and packages designed to accelerate your Upwork success
            </p>
          </AnimatedGroup>
        </div>
      </section>
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    {offer.originalBreakdown && (
                      <div className="text-center mb-6">
                        <p className="text-sm text-muted-foreground mb-2">Original prices:</p>
                        ...
                        <p className="text-sm text-muted-foreground mt-2">
                          Total: <span className="line-through">{offer.originalPrice}</span>
                        </p>
                      </div>
                    )}
                    ...
                    <div className="space-y-3 text-left mb-6 flex-1">
                      <h4 className="font-semibold text-sm text-foreground">What you'll get:</h4>
                    ...
                    <div className="mt-auto pt-4">
                      <div className="bg-foreground/10 rounded-[14px] border p-0.5">
                        <Button
                          ...
                          asChild={!offer.onButtonClick && offer.href ? true : undefined}
                        >
                          {!offer.onButtonClick && offer.href ? (
                            <Link href={offer.href}>
                              <span className="text-nowrap">{offer.buttonText}</span>
                            </Link>
                          ) : (
                            <span className="text-nowrap">{offer.buttonText}</span>
                          )}
